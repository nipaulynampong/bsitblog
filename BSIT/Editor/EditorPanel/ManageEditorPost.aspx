<%@ Page Language="vb" AutoEventWireup="true" CodeFile="ManageEditorPost.aspx.vb" Inherits="BSIT.EditorManagePosts" %>
...
<head runat="server">
    ...
    <style>
        ...
        .btn-primary {
            background: linear-gradient(90deg, var(--maroon-primary) 0%, var(--maroon-light) 100%);
            color: white;
            border: none;
        }

        .btn-primary:hover {
            background: linear-gradient(90deg, var(--maroon-dark) 0%, var(--maroon-primary) 100%);
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            <h1 class="page-title"><i class="fas fa-newspaper"></i> My Content Management</h1>
            <div class="card">
                <div class="card-header">
                    <h5><i class="fas fa-list"></i> Manage My Posts</h5>
                    <asp:Button ID="btnAddNew" runat="server" Text="Create New Post" CssClass="btn btn-add" OnClick="btnCreatePost_Click" />
                </div>
                <div class="card-body">
                    <div class="action-buttons">
                        <div class="search-box">
                            ...
                            <asp:TextBox ID="txtSearch" runat="server" CssClass="search-input" placeholder="Search posts..."></asp:TextBox>
                    ...
                    <div class="gridview-container">
                                ...
                                <asp:TemplateField HeaderText="Actions">
                                    <ItemTemplate>
                                        <div class="action-buttons-cell">
                                            ...
                                            <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn btn-sm btn-info" 
                                                CommandName="EditPost" CommandArgument='<%# Eval("PostID") %>' 
                                                Visible='<%# Eval("Status").ToString() = "Draft" Or Eval("Status").ToString() = "Rejected" %>'
                                                ToolTip="Edit Post">
                                                <i class="fas fa-edit"></i>
                                            </asp:LinkButton>
                                            
                                            <!-- Submit for Approval -->
                                            <asp:LinkButton ID="btnSubmitForApproval" runat="server" CssClass="btn btn-sm btn-warning" 
                                            ...
                                            <!-- View Feedback (for rejected posts) -->
                                            <asp:LinkButton ID="btnViewFeedback" runat="server" CssClass="btn btn-sm btn-secondary" 
                                                CommandName="ViewFeedback" CommandArgument='<%# Eval("PostID") %>' 
                        ...
                        <asp:Panel ID="pnlNoResults" runat="server" CssClass="no-results" Visible="false">
                            ...
                            <asp:Button ID="btnAdd" runat="server" Text="Create New Post" CssClass="btn btn-primary" OnClick="btnCreatePost_Click" />
                        </asp:Panel>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h5><i class="fas fa-chart-pie"></i> My Content Stats</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2 col-6 mb-3 text-center">
                            <div class="p-3 bg-light rounded-3">
                                <h4><asp:Label ID="lblTotalPosts" runat="server" Text="0"></asp:Label></h4>
                                <p class="mb-0">Total Posts</p>
                            </div>
                        </div>
                        <div class="col-md-2 col-6 mb-3 text-center">
                            <div class="p-3 bg-light rounded-3">
                                <h4><asp:Label ID="lblPublished" runat="server" Text="0"></asp:Label></h4>
                        ...
                        <div class="col-md-2 col-6 mb-3 text-center">
                            <div class="p-3 bg-light rounded-3">
                                <h4><asp:Label ID="lblDrafts" runat="server" Text="0"></asp:Label></h4>
                                <p class="mb-0">Drafts</p>
                            </div>
                        </div>
                        <div class="col-md-2 col-6 mb-3 text-center">
                            <div class="p-3 bg-light rounded-3">
                                <h4><asp:Label ID="lblRejected" runat="server" Text="0"></asp:Label></h4>
                                <p class="mb-0">Rejected</p>
                            </div>
                        </div>
                        <div class="col-md-2 col-6 mb-3 text-center">
                            <div class="p-3 bg-light rounded-3">
                                <h4><asp:Label ID="lblTotalViews" runat="server" Text="0"></asp:Label></h4>
